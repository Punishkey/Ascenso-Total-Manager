...
class Players(commands.Cog):
    ...
    # COMENTO ESTOS COMANDOS Y NO LOS BORRO POR SI ALGUIEN LOS QUIERE USAR.
    # AL IMPLEMENTAR TANTO FICHA COMO PLANTILLA DENTRO DEL MENU DE ESTADIO, NO ES NECESARIO
    # IGUALMENTE EN UN FUTURO PUEDE QUE SI LOS NECESITE, PERO AHORA NO.
